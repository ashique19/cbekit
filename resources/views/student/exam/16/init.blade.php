@extends('student.exam.layout2')
@section('title')Exam window - {{ settings()->application_name }} @stop

@section('main')


@include('student.exam.f-5-6-7-8-9-instruction')

@for( $i = 1; $i < count($questions) +1 ; $i++ )
<window id="{{ $i + 100 }}" class="hidden white-bg">
    
    <!--Header-->
    <nav class="navbar lightGray-bg exam-nav nav-type2">
        <div class="container">
    ...
    <article class="hero-body exam-screen white-bg padding-0 margin-top-100 margin-bottom-100">
