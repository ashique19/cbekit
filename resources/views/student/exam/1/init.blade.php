                ...
                <div class="navbar-end">
                    <span class="navbar-item white-border-right font-weight-700 font-size-12">
                        <p class="text-center black-text">
                            ...
                            <br />
                            <br />
                            <span class="remaining-time" data-minutes="{{ $duration }}">{{ $duration < 60 ? '00:'.$duration.':00' : floor( $duration/60 ).':'. round( ( $duration / 60 - floor( $duration / 60 ) ) * 100 ).':00' }}2:00:00</span>
                        </p>
                    </span>
                    <span class="navbar-item white-border-right font-weight-700 font-size-12">
                        <p class="text-center">
                            ...
                            <br>
                            <br>
                            <span class="orange-text" data-toggle="modal" data-target="#exam-progress-detail">
