        ...
        <div class="exam-page">
            ...
            <section class="columns is-multiline">
                ...
                <div class="column is-12-desktop is-12-mobile columns is-multiline" id="answers">
                    ...
                    <div class="column is-6-desktop is-12-mobile">
                        <h2 class="subtitle is-4">Your Answer(s):</h2>
                        @if( $answers->count() > 0 )
                        <ul>
                        @foreach( $answers as $answer )
                        <li>@if($answer->achieved_mark > 0)<i class="fa fa-check green-text"></i> @else <i class="fa fa-times red-text"></i> @endif
                            @if( $answer->qtype == 'word' )Word 
                            @elseif( $answer->qtype == 'excel' )Excel 
                            @else {{ $answer->given_answer }} @endif 
                            <span class="tag is-small margin-left-20">{{ $answer->achieved_mark }} marks</span>
                        </li>
                        @endforeach
                        <hr>
                        <li>
                                ...
                                <p>
                                    ...
                                    <small>
                                        <button type="button" 
                                                ...
                                                data-container="body"
                                                data-content='
                                                {!! Form::open(["url"=>action("StudentExams@comment", [$attempt->id, $question->id])]) !!}
                ...
                <div class="column is-12-desktop is-12-mobile">
                    <h3 class="subtitle is-4">Comment on this Question/Answer</h3>
                    {!! Form::open(['url'=>action('StudentExams@comment', [$attempt->id, $question->id])]) !!}
                    {!! Form::textarea('comment', null, ['class'=>'textarea', 'rows'=> 2] ) !!}
