<div class="modal fade bs-example-modal-sm" id="excel" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
      ...
      <section class="columns is-multiline">
          ...
          {!! Form::open([ 'url'=> action('Questions@update', $exam->id), 'method'=> 'PATCH', 'class'=> 'column is-12 padding-0 columns is-multiline' ]) !!}
            ...
            <div class="column is-12 margin-bottom-5">
                <h2 class="subtitle is-2">Section: C (Excel side-by-side)</h2>
            </div>
            ...
            {!! Form::hidden('display_helper', 'excel-side-by-side') !!}
            

            <div class="column is-6 editor-container offwhite-bg black-text padding-bottom-40 padding-10 white-border-right-5">
        
                <textarea name="detail[]" class="textarea air min-height-400" placeholder="Question block" rows="40" ></textarea>
                
            </div>

            <div class="column is-6 editor-container offwhite-bg black-text padding-bottom-40 padding-10 white-border-left-5">
