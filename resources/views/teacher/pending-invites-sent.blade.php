...
<article class="columns is-multiline">
    ...
    <main class="column is-10-desktop is-12-mobile columns is-multiline">
        ...
        <div class="column is-12-desktop is-12-mobile">
            ...
            <h1 class="title is-1">
                <span class="has-text-info"><a href="{{ action('TeacherCourses@index', $course->name) }}">{{ $course->name }}</a> > PENDING INVITES (SENT)</span>
            </h1>
        ...
        <div class="column is-12-desktop is-12-mobile">
            ...
            <h4 class="subtitle is-4">Pending invites (Sent)</h4>
