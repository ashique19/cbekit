...
<article class="columns is-multiline">
    ...
    <aside class="column is-12-desktop is-12-mobile">
        ...
        <h1 class="title is-3">
            <span class="has-text-info">USERS:</span> Pending Activation ({{ $users->count() > 0 ? $users->total() : 0 }})
        </h1>
    ...
    <main class="column is-12-desktop is-12-mobile">
        ...
        <table class="table is-fullwidth is-narrow is-responsive is-bordered">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Type</th>
                            ...
                            <button 
                                ...
                                <div class="box">
                                    ...
                                    <p class="has-text-centered">
                                        <a class="button is-small is-danger" href="{{ action('AdminUsers@activateUser', str_random(40).$user->id.str_random(20)  ) }}">YES</a>
                                    </p>
                                </div>
                                '
                            >Activate</button>
